...
axes[0,0].set_ylabel('Fmax', fontweight='bold')
...
axes[0,1].set_ylabel('Fmax', fontweight='bold')
...
axes[0,2].set_ylabel('Fmax', fontweight='bold')
...
axes[1,0].set_ylabel('Smin', fontweight='bold')
...
axes[1,1].set_ylabel('Smin', fontweight='bold')
...
axes[1,2].set_ylabel('Smin', fontweight='bold')
